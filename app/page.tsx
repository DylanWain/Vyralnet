...
const assetAudit = [
  ...
  { element: 'Scout glow ball', source: '280 × 280 group at 61,134 · 170px core · 92px glow · 58 × 32 highlight · 9 vector/effect layers', format: 'SVG + CSS', status: 'Awaiting export' },
